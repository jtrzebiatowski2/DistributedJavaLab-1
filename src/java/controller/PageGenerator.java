 ...
 * @author J-Tron
 */
@WebServlet(name = "PageGenerator", urlPatterns = {"/PG"})
public class PageGenerator extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<td> row 1, cell 3 </td>");
            out.println("</tr>");
            out.println("<tr>");
            out.println("<td> row 2, cell 1 </td>");
            out.println("<td> row 2, cell 2 </td>");
            out.println("<td> row 2, cell 3 </td>");
            out.println("</tr>");
            out.println("<tr>");
            out.println("<td> row 3, cell 1 </td>");
            out.println("<td> row 3, cell 2 </td>");
            out.println("<td> row 3, cell 3 </td>");
            out.println("</tr>");
            out.println("</table>");
            out.println("</body>");
            out.println("</html>");
